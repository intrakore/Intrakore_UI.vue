...
export function triggerVariantClasses(
  ...
  return {
    subtle:
      'border border-outline-gray-3 bg-surface-gray-2 hover:border-outline-blueprint-3 hover:bg-surface-gray-3',
    outline:
      'border border-outline-gray-4 bg-surface-white hover:border-outline-blueprint-3',
    ghost:
      'border border-transparent bg-transparent hover:bg-surface-blueprint-2focus:bg-surface-blueprint-2',
  }[variant]
}

export const triggerBaseClasses =
  'relative inline-flex items-center gap-2 text-left text-ink-gray-7 outline-none transition-[background-color,border-color,box-shadow] duration-150 ease-[cubic-bezier(0.23,1,0.32,1)] focus-within:ring-2 data-[state=open]:ring-2 ring-outline-blueprint-2'

export const inputClasses =
  'min-w-0 flex-1 border-0 bg-transparent p-0 text-ink-gray-8 outline-none ring-0 placeholder:text-ink-gray-6 focus:border-0 focus:outline-none focus:ring-0'
