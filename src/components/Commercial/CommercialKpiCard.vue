<template>
  <div class="csh-metric-card bg-surface-white border border-outline-gray-2 rounded-xl px-6 py-3 flex flex-col gap-3 shrink-0 cursor-pointer relative overflow-hidden">
